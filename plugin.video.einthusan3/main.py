...
def play_video(name, url, language, mode):
    ...
    if whathd == "uhd":
        ...
        if ret1 == 0:
            ...
            mainurlajax = "https://einthusan.ca/ajax/movie/watch/%s/?lang=%s" % (
                url,
                lang,
            )
            print(mainurlajax)
            headers = {
                ...
                "Referer": "https://einthusan.ca/movie/browse/?lang=tamil",
        ...
        if ret1 == 1:
            ...
            mainurl = "https://einthusan.ca/movie/watch/%s/?lang=%s&uhd=true" % (
                url,
                lang,
            )
            mainurlajax = (
                "https://einthusan.ca/ajax/movie/watch/%s/?lang=%s&uhd=true"
                % (url, lang)
            )
...
def get_video(s, mainurl, mainurlajax, headers=None):
    ...
    xbmc.log("lnk: " + lnk, level=xbmc.LOGNOTICE)
    urlnew = lnk + (
        "|https://einthusan.ca&Referer=%s&User-Agent=%s"
        % (
            mainurl,
